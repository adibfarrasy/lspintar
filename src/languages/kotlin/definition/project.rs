...
/// Find inner class within a class (Kotlin-specific)
fn find_inner_class(
    tree: &tree_sitter::Tree,
    source: &str,
    ...
    // Find inner class declarations by name (Kotlin-specific)
    let class_query_text = r#"
        (class_declaration (type_identifier) @class_name)
        (object_declaration (type_identifier) @class_name)
        (interface_declaration (type_identifier) @class_name)
        (enum_class_declaration (type_identifier) @class_name)
    "#;
...
/// Find inner method within a class (Kotlin-specific)
fn find_inner_method(
    ...
    // First find the inner class (Kotlin-specific)
    let class_query_text = r#"
        (class_declaration (type_identifier) @class_name)
        (object_declaration (type_identifier) @class_name)
        (interface_declaration (type_identifier) @class_name)
...
/// Find inner property/field within a class (Kotlin-specific)
...
/// Find method within a node (Kotlin-specific)
fn find_method_in_node(
    ...
    let query_text = r#"
        (function_declaration (simple_identifier) @method_name)
...
/// Find property within a node (Kotlin-specific)
