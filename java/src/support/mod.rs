...
impl JavaSupport {
    ...
    fn find_ident_at_position_impl(
        ...
        // contexts above (e.g. an unqualified method call `log(...)` with no
        // `object` field, or a bare field reference used as an expression
    ...
    fn get_class_declarations(&self, tree: &Tree, source: &str) -> Vec<ClassDeclarationData> {
        ...
        cursor
            ...
            .for_each(|m| {
                ...
                // Collect method signatures defined directly in this class body,
                // scoping the walk to the class/enum body so inner classes are
                // ignored.
